...
public class ArrayFunctionsApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The first 10 players lost 20 point");
        Arrays.fill(gamerPoints, 0, 10, 180);
        System.out.println(Arrays.toString(gamerPoints));

        System.out.println("Gamer 10 gained 50 points");
        gamerPoints[9] += 50;
        System.out.println(Arrays.toString(gamerPoints));
        ...
        if (Arrays.equals(lastFivePoints, topFivePoints)) {
            ...
            System.out.println("The top 5 players do not have the same points as the last 5 players");
        }
